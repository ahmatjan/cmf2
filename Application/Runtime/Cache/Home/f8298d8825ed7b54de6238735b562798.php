...
<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				...
				<td><?php if($vo['type'] == 0): ?>不分人<?php else: ?>分人<?php endif; ?></td>
				<td><?php if($vo['count'] == 0): ?>未引用<?php else: echo ($vo['count']); ?>次<?php endif; ?></td>
				<td class="action">
				...
				<td colspan="4" class="noborder">				
					<ul class="add">
						...
						<li>
							...
							<input type="radio" value="0" id="type0" name="type" checked />不分人
							<input type="radio" value="1" id="type1" name="type" />分人
						</li>
						<li>
							<input type="hidden" id="audit" name="audit" value="<?php echo ($audit); ?>" />
