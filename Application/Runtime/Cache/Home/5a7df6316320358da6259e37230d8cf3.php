...
<div class="container tc-main">
    ...
    <div class="row">
		<div class="span9">
			<div class="">
<?php if(is_array($articles)): $i = 0; $__LIST__ = $articles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="list-boxes">
					<h2><a href="article?id=<?php echo ($vo['id']); ?>" target="_blank"><?php echo ($vo['title']); ?></a></h2>
					<p><?php echo ($vo['contract']); ?>...</p>
					<div>
						<div class="pull-left">
							<div class="list-actions">
							<a href="javascript:;"><i class="fa fa-eye"></i><span><?php echo ($vo['click']); ?></span></a>
							</div>
						</div>
						<a class="btn btn-warning pull-right" target="_blank" href="article?id=<?php echo ($vo['id']); ?>">查看更多</a>
					</div>
		...
		<div class="span3">
			...
			<div class="tc-box">
				<?php if($subFolder): ?><div class="headtitle">
	        		<h2>文章类别</h2>
	        	</div>
				<div class="posts">
					<?php if(is_array($subFolder)): $i = 0; $__LIST__ = $subFolder;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="folder?id=<?php echo ($vo['id']); ?>"><?php echo ($vo['name']); ?></a><br /><?php endforeach; endif; else: echo "" ;endif; ?>
				</div>
				<?php else: ?>
	        	<div class="headtitle">
	        		<h2>最新发布</h2>
				...
				<div class="posts">
					<?php if(is_array($posts)): $i = 0; $__LIST__ = $posts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="article?id=<?php echo ($vo['id']); ?>" target="_blank"><?php echo ($vo['title']); ?></a><br /><?php endforeach; endif; else: echo "" ;endif; ?>
				</div><?php endif; ?>
			</div>
