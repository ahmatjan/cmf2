	...
	<div class="container tc-main">
		<div class="row">
			<div class="span6 offset3">
				...
				<form class="form-horizontal J_ajaxForms" method="post">
					<div class="control-group">
						<label class="control-label" for="input_username">账号</label>
						<div class="controls">
							<input type="text" id="input_username" name="userid" placeholder="请输入用户名" class="span3">
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<img class="verify_img" src="<?php echo ($siteInfo['webFolder']); ?>code" onclick="this.src='<?php echo ($siteInfo['webFolder']); ?>code?time='+Math.random();" style="cursor: pointer;" title="点击获取"/>						</div>
					</div>
					<div class="control-group">
					...
					<div class="control-group">
						<label class="control-label" for="input_repassword"></label>
						<div class="controls">
							<button class="btn btn-primary J_ajax_submit_btn" type="button">确定</button>
						</div>
					</div>
					...
					<div class="control-group">
						...
						<div class="controls">
							<ul class="inline">
								<li><a href="<?php echo ($siteInfo['webFolder']); ?>user/reg">现在注册</a></li>
							</ul>
						</div>
					</div>
				</form>
...
<!-- Footer
	...
	$(document).ready(function(){
		$('.J_ajax_submit_btn').click(function(){
			...
			$.post('doLogin.html', {userid: userid, password: password, code: verify}, function(data){
				switch(data){
					case 'success':
						alert('登录成功');
						location.href = '../index';
